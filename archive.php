...
<div id="rs-blog" class="rs-blog blog-page">
   <?php
    ...
    if(!empty($dabble_option['blog-layout']) || !is_active_sidebar( 'sidebar-1' )){
        $blog_layout = !empty($dabble_option['blog-layout']) ? $dabble_option['blog-layout'] : '';
        $blog_grid   = !empty($dabble_option['blog-grid']) ? $dabble_option['blog-grid'] : '';
                            ...
                            <article <?php post_class();?>>
                                ...
                                <?php if ( has_post_thumbnail() ) {?>
                                    <div class="blog-img">
                                      ...
                                      <?php 
                                          if(!empty($dabble_option['blog-category'])){
                                              if($dabble_option['blog-category'] == 'show'){
                                                  if(get_the_category()): 
                                          ?>                                          
                                                    <?php                                                                
                                ...
                                ?> 
                                  ...
                                  <div class="full-blog-content">
                                              ...
                                              <ul class="btm-cate">
                                                ...
                                                <?php } ?>
                                                 ...
                                                 if ($dabble_option['blog-author-post'] == 'show'): ?>
                                                  <li>
                                                        <div class="author">
                                                          <?php if(!empty($dabble_option['admin-link-blog'])){ ?>
                                        ...
                                        <div class="blog-desc">   
                                            <?php echo dabble_custom_excerpt(30);?>                                     
                                        </div>

                                        <?php 
                                            $no_view = "";
                                            if ( !empty($dabble_option['view-comments']) && $dabble_option['view-comments'] == 'hide'){
                                                $no_view = "left-btn";
                                            }
                                            if(!empty($dabble_option['blog_readmore'])):?>
                                                <div class="blog-button <?php echo esc_attr($no_view); ?>">
                                                    <a href="<?php the_permalink();?>">
                                                        <?php echo esc_html($dabble_option['blog_readmore']); ?>
                                                    </a>
                                                </div>
                                        <?php endif; ?>

                                      <?php if(empty($dabble_option['blog_readmore'])):?>
                                          <div class="blog-button <?php echo esc_attr($no_view); ?>">
                                            <a href="<?php the_permalink();?>"><?php esc_html_e('Continue Reading', 'dabble');?></a>
                                          </div>
                                      <?php endif; ?>
