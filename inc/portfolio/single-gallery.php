...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">   
                ...
                <div class="ps-informations">
                    <h3 class="info-title"><?php esc_html_e('Project Details','dabble');                  
                    ?></h3>                    
                    <ul>
                      <li>
                        <span><?php esc_html_e('Category:', 'dabble');?></span>
                        <?php 
                      ...
                      <?php if($post_client){?>
                      <li><span><?php esc_html_e('Client:','dabble');?>  </span><?php   echo esc_html($post_client); ?></li>
                      <?php }?>

                      <?php if($post_location){?>
                      <li><span><?php esc_html_e('Location:','dabble');?> </span><?php echo esc_html($post_location); ?></li>
                      <?php }?>

                      <?php if($post_date){?>
                      <li><span><?php esc_html_e('Completed Date:','dabble');?>  </span><?php   echo esc_html($post_date); ?></li>
                      <?php }?>
                      
                      <?php if($post_project_value){?>
                      <li><span><?php esc_html_e('Project Value:','dabble');?>  </span><?php  echo esc_html($post_project_value); ?></li>
                      <?php }?>
                       <?php if($post_surface_area){?>
                      <li><span><?php esc_html_e('Mananer:','dabble');?> </span><?php echo esc_html($post_surface_area); ?></li>
                      <?php }?>

                      <?php if($post_created){?>
                      <li><span><?php esc_html_e('Designer:','dabble');?> </span><?php echo esc_html($post_created); ?></li>
                      <?php }?>
        ...
        <div class="ps-image-wrap clearfix">
            <h3 class="p-gallery-title"><?php esc_html_e('Project Gallery', 'dabble') ?></h3>
