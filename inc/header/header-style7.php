...
<header id="rs-header" class="ddk header-style7 mainsmenu<?php echo esc_attr($main_menu_hides);?> <?php echo esc_attr($main_menu_center);?> <?php echo esc_attr($main_menu_icon);?>">
    ...
    <div class="header-inner<?php echo esc_attr($sticky_menu);?>">
      ...
      <?php
        ...
        ?>
        <div class="menu-area menu_type_<?php echo esc_attr($main_menu_type);?>" <?php echo wp_kses($menu_bg_color, 'dabble');?>>
            <div class="<?php echo esc_attr($header_width);?>">
                <div class="menu_one">
                        ...
                        if(!empty($dabble_option['quote'])):   
                          $quote_menu = $dabble_option['quote'];                        
                        endif;        
                        ?>
                        ...
                        <div class="col-cell header-quote">                         
                            ...
                            if($rs_top_search != 'hide'):
                              if(!empty($dabble_option['off_search']) || ($rs_top_search == 'show') ): ?>
                           ...
                           if($rs_offcanvas != 'hide'):
                            ...
                            <?php if($rs_show_quote != 'hide'){
                                if(!empty($dabble_option['quote'])){ ?>
                                <div class="btn_quote"><a href="<?php echo esc_url($dabble_option['quote_link']); ?>" class="quote-button"><?php  echo esc_html($dabble_option['quote']); ?></a></div>
                            <?php } } ?>
                        </div> 
                    </div>
                </div>
