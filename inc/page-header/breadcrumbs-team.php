            ...
            <div class="col-md-12 text-center">
              <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
                <?php 
                    ...
                    ?>
                    <h1 class="page-title">
                        <?php if(!empty($dabble_option['team_sigle_txt'])){
                            echo esc_html($dabble_option['team_sigle_txt']);
                         } else {
                            if($content_banner !=''){
...
elseif (!empty($dabble_option['team_single_image']['url'])) {?>
<div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $dabble_option['team_single_image']['url'] );?>')">
    <div class="<?php echo esc_attr($header_width);?>">
      <div class="row">
        <div class="col-md-12 text-center">
          <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
