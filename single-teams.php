                    ...
                    <div class="col-lg-7 rs-con-info">
                        ...
                        <?php if(!empty($short_desc)): ?>
                            <div class="short-desc">
                                <?php echo wp_kses($short_desc, 'dabble'); ?>
                            </div>
                        <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="project-desc">  
                           <h3 class="title-bg-gray padding-top"><?php esc_html_e( 'Biography','dabble' );?></h3>              
                            <?php
                                the_content()
                            ?>
                        </div>
                    ...
                    ?>
                    <div class="col-lg-5">
                        <h3 class="title-bg-gray padding-top"><?php esc_html_e( 'Professional Skills','dabble' );?></h3> 
                        <div class="team-skill"> 
                            <div class="row">       
                                <?php foreach ( $team_member_skill as $value ) { ?>
                                  <div class="col-md-12">
                                      <div class="progress rs-progress">
                                          <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo wp_kses($value['skill_level'], 'dabble'); ?>%">

                                              <span class="pb-label"><?php echo wp_kses($value['skill_title'], 'dabble'); ?></span>
                                              <span class="pb-percent"><?php echo wp_kses($value['skill_level'], 'dabble'); ?>%</span>
